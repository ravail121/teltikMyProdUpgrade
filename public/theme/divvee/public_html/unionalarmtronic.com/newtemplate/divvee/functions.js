$(function() {
    ...
    $('body').on('click','.cart .closing',function(){
        $('.cart').removeClass('showing');
        $('body').removeClass('noScroll');
        if($('.cart').hasClass('showing')) {
            $('.overlay').fadeIn(300);
    ...
    // fix the shopping cart 
        ...
        $(window).scroll(function() { 
            if($('.cart').length && window.matchMedia('(min-width: 959px)').matches) {
    ...
    //credit cards icons
    $('body').on('focus','.paymentsWrapper  .number > input',function(){
        $(this).parent().siblings(".cccards").hide();
    });
    $('body').on('blur','.paymentsWrapper  .number > input',function(){
        $(this).parent().siblings(".cccards").show();
    });

    //samshipping is clicked hide the the form
    $('body').on('click','.paymentsWrapper .sameAsShipping  input[type="checkbox"]',function(){ 
