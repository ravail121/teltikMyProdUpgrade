            ...
            <div class="row no-margin text-center">
                ...
                <div class="add-top-6 xs-add-top-4">
                    ...
                    <ul class="nav nav-tabs" id="chooseDeviceTab" role="tablist">
                        <li role="presentation" class='data-button'><a href="#data" aria-controls="data" role="tab" data-toggle="tab">Data</a></li>
                        <li role="presentation" class="active voice-button"><a href="#voice" aria-controls="voice" role="tab" data-toggle="tab">Voice</a></li>
                    </ul>
                    <!-- Tab panes -->
                    <div class="tab-content pad-top-3">
                        ...
                        <div role="tabpanel" class="tab-pane active" id="voice">
                            @if (count($voicePlans) != 0)
                                <div class="plan-wrap">
                                    @foreach($voicePlans as $key => $plan)
                                        @if($plan['show'] == 1 || $plan['show'] == 2)
                                            <div class="col-md-4 col-sm-12 item{{ (in_array($plan['id'], $checkSession)) ? ' added' : '' }}">
                            ...
                            @else
                                <h5 class="t-gray-2 bold add-top-35">Oops! No Voice Plans are available here.</h5>
                            @endif
                            <div class="add-top-8 xs-add-top-4">
                                <a href="javascript:void(0);" class="btn style2 continue-without-plan" style='padding: 0 35px;'>Continue Without Plan</a>
                            </div>
...
@push('js')
    <script>
        ...
        $(function(){
            ...
            var defaultImei, clearAreaCode, sessionCart, deviceId, requireAreaCode, planCarrierId,associateWithDevice;
